...
proto_out=data/prototypes/skip_10
...
python src/generate_prototypes/gen_proto_data.py --imgs $render_out/rendered_50 --skip 10 --out $proto_out/proto_50.pkl
python src/generate_prototypes/gen_proto_data.py --imgs $render_out/rendered_20 --skip 10 --out $proto_out/proto_20.pkl
python src/generate_prototypes/gen_proto_data.py --imgs $render_out/rendered_all --skip 10 --out $proto_out/proto_all.pkl
